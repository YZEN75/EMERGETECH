...
PHASE_EW_YELLOW = 1
PHASE_BEW_GREEN = 2  # action 1 code 01
PHASE_BEW_YELLOW = 3
...
class Simulation:
    ...
    def _set_green_phase(self, action_number):
        ...
        if action_number == 0:
            ...
            traci.trafficlight.setPhase("TL", PHASE_BEW_GREEN)
    ...
    def _get_state(self):
        ...
        for car_id in car_list:
            ...
            if  lane_id == "W2TL_1" or lane_id == "W2TL_2":
                lane_group = 0
            elif lane_id == "W2TL_3" or  lane_id == "W2TL_0":
                lane_group = 1
            elif lane_id == "E2TL_0" or lane_id == "E2TL_1" or lane_id == "E2TL_2":
                lane_group = 2
            elif lane_id == "E2TL_3" or lane_id == "E2TL_0":
                lane_group = 3
            else:
                lane_group = -1
