...
def set_sumo(gui, sumocfg_file_name, max_steps):
    ...
    sumo_cmd = [sumoBinary, "-c", os.path.join('C:\\Users\\pc\\Desktop\\TRAFFIC SYSTEM\\SUMO222\\Deep-QLearning-Agent-for-Traffic-Signal-Control-1\\TLCS\\intersection\\sumo_config.sumocfg'), "--no-step-log", "true", "--waiting-time-memory", str(max_steps)]
